      ...
      <header className="bg-white/80 backdrop-blur-md shadow-sm border-b border-teal-100 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            {user && (
              <div className="flex items-center gap-3 px-4 py-2 bg-gradient-to-r from-teal-50 to-cyan-50 rounded-xl border border-teal-200">
                {user.picture ? (
                  <img
                    src={user.picture}
                    alt={user.name}
                  ...
                  <div className="w-8 h-8 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-full flex items-center justify-center shadow-sm">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-teal-100">
          ...
          <form onSubmit={handleCreatePost}>
            <textarea
              ...
              className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent resize-none transition"
              rows={4}
              maxLength={500}
            />
            <div className="mt-4 flex justify-between items-center">
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white font-semibold rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105 transition-all duration-200 shadow-md hover:shadow-lg"
              >
                {posting ? (
